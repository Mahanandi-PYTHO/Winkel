...
def add_cart(request, product_id):
    ...
    if current_user.is_authenticated:
        ...
        if is_cart_item_exists:
            ...
            # to select multiple item with diff varitions for usung  instead of get create
            # existing variance
            # current variation
            # item id
            ex_var_list = []
            ...
            if product_variation in ex_var_list:
                # incresing the cartitem quantity
    ...
    # user not authenticated means else condition.
    else:
        product_variation = []
        if request.method == 'POST':
            for item in request.POST:
        ...
        if is_cart_item_exists:
            ...
            # to select multiple item with diff variations for using  instead of get create
            # existing variance
            # current variation
            # item id
            ex_var_list = []
